...
export default function Navbar() {
  ...
  return (
    ...
    <nav className="absolute top-10 left-1/2 -translate-x-1/2 w-[90%] max-w-7xl z-50 flex items-center justify-between">
      ...
      */}
      {menuOpen && (
        <div className="absolute top-16 right-0 bg-white dark:bg-[#171717] border border-gray-200 dark:border-[#2E2F2F] rounded-lg p-4 w-48 shadow-xl flex flex-col gap-2 animate-in slide-in-from-top-2 fade-in md:hidden">
  ...
  return (
    <a
      ...
      className={`group flex items-center gap-2 transition-colors duration-200 ${
        mobile ? "p-2 hover:bg-gray-100 dark:hover:bg-[#2E2F2F] rounded-md" : "hover:text-purple-600 dark:hover:text-purple-400"
      }`}
    >
