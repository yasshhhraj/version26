...
const EventsPage = () => {
    return (
        <div className={'relative h-screen w-full overflow-clip bg-[url("/Assets/grid_hero.png"),url("/Assets/ellipse.png")] dark:bg-[url("/Assets/grid_hero.png"),url("/Assets/ellipse.png")] bg-center bg-no-repeat bg-white dark:bg-black transition-colors duration-300'}>

            <div
                className={'w-[250%] sm:w-[150%] md:w-4/5 aspect-square scale-x-120 bg-black  absolute flex items-start justify-center top-[90%] sm:top-[85%] md:top-[80%] left-1/2 transform -translate-x-1/2 rounded-full border border-[#4A68FF]/20 transition-colors duration-300'}>
                <Image src={'/Assets/shine.svg'} alt={'decorative shine'} width={1980} height={1000}
                       className={'w-full scale-x-90 transform -translate-y-10 md-translate-y-5 md:-translate-x-5 opacity-80 dark:opacity-60 transition-opacity duration-300'}/>
            </div>
            <p className={'text-[128px]  font-bold md:text-[450px] absolute top-16 md:-top-8 left-1/2 transform -translate-x-1/2 text-[#4600BE]/40 backdrop-blur-2xl backdrop-opacity-30'}>EVENTS</p>
            <div
                className={'w-full h-[65%] absolute bottom-10  flex items-center justify-center gap-10 overflow-clip'}>
                <Carousal />
            </div>
        </div>
    );
...
export function Carousal() {
    ...
    return (
        <div className="carousal h-screen w-full  flex items-center justify-center  overflow-clip">
