...
const heroData: HeroData = {
  "heroSection": {
    ...
    "mainTitle": "COGNIX",
    "subtitle": "VERSION '26",
    "themeTitle": { // Kept for type compatibility if needed, but unused in new Hero
      "prefix": "",
      "highlight": "",
      "suffix": ""
    },
    "tagline": "INTELLIGENCE WITHOUT LIMITS",
    "description": "Beyond static algorithms. Join the 33rd edition as we bridge the gap between binary code and infinite reasoning.",
    "buttons": {
