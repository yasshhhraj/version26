    ...
    <div className="w-full h-screen relative flex flex-col md:flex-row items-center overflow-hidden bg-[#050507]">
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 sm:px-8 pointer-events-none flex-1 flex items-center justify-center md:justify-start">
        ...
        >
          ...
          >
            {/* Glow behind title */}
            <div className="absolute inset-0 bg-gradient-to-r from-cyan-500/40 via-blue-500/40 to-purple-500/40 blur-3xl scale-150 opacity-60" />
            <h1 className="relative text-7xl font-bold tracking-tight leading-none">
              <span className="bg-clip-text text-transparent bg-gradient-to-r from-cyan-400 via-blue-400 to-purple-500 drop-shadow-[0_0_50px_rgba(59,130,246,0.6)]">
                {data.mainTitle}
              </span>
            </h1>
          </motion.div>
          ...
          >
            ...
            >
              ...
              <div className="absolute inset-0 bg-gradient-to-r from-[#4600be] to-[#6b21a8] rounded-full" />
              <div className="absolute inset-[1px] bg-gradient-to-r from-[#4600be] to-[#371768] rounded-full" />
              {/* Glow effect */}
              <div className="absolute inset-0 bg-gradient-to-r from-purple-600/50 to-blue-600/50 rounded-full blur-xl opacity-50 group-hover:opacity-70 transition-opacity" />
      ...
      >
        ...
        <div className="w-[20px] h-[32px] rounded-full border border-white/20 flex justify-center pt-2">
            <motion.div 
                animate={{ y: [0, 8, 0] }}
                transition={{ duration: 1.5, repeat: Infinity, ease: "easeInOut" }}
